<template>
    <footer class="bg-primary-900 dark:bg-gray-900">
        <div class="grid grid-cols-1 gap-8 py-8 px-6 md:grid-cols-4">
            ...
            <div>
                <h2 class="mb-6 text-lg font-semibold text-gray-500 uppercase dark:text-gray-400">Nuestras Oficinas</h2>
                <ul class="text-gray-300 dark:text-gray-400">
                    
                    <li class="mb-4">
                        <a 
                            href="https://www.google.com.mx/maps/place/Grupo+Cumbres/@22.1537956,-100.9962549,17z/data=!4m5!3m4!1s0x842a9f4d0584012d:0x7ff21b59f34f0c7d!8m2!3d22.1537906!4d-100.9940662" 
                            class="hover:text-secondary-50 hover:font-bold hover:underline"
                            target="_blank"
                            >
                                Nicolas Zapata #719 Col Tequisquiapan C.P. 78230 Sn Luis Potosí, México
                        </a>
                    </li>
