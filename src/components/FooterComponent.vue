    ...
    <footer class="bg-primary-900 dark:bg-gray-900">
        ...
        <div class="py-6 px-4 bg-gray-100 dark:bg-gray-700 md:flex md:items-center md:justify-between">
            ...
            <div class="flex mt-4 space-x-6 sm:justify-center md:mt-0">
                ...
                <a href="https://www.instagram.com/grupo_cumbres/"  target="_blank" class="text-gray-400 hover:text-instagram-100 dark:hover:text-white">
